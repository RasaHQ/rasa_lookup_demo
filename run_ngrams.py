...
def get_path_dicts(key):
    ...
    td_dict = {
        'company': 'data/company/company_full.json',
    }
    td_lookup_dict = {
        'company': 'data/company/company_full_lookup.json',
    }
    td_ngrams_dict = {
        'company': 'data/company/company_full_ngrams.json',
    }
    td_both_dict = {
        'company': 'data/company/company_full_both.json',
    }
    model_dir_dict = {
        'company': 'data/models',
    }
...
def print_metrics(metric_list):
    ...
    if metric_list:
        ...
        print("after adding both lookup table(s) and ngrams,  demo '{}' had:".format(key))    
