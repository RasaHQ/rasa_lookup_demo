...
if __name__ == "__main__":
    ...
    company_df = company_df.loc[company_df['name'].str.replace(' ','').str.isalpha().fillna(False)]
    ...
    combined_df = combined_df.loc[combined_df['element'].str.replace(' ','').str.isalpha().fillna(False)]
